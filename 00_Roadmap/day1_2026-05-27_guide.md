# Day 1 学习指南 — Phase 1 启动（2026-05-27 历史版）

> **2026-06-01 起 Phase 1 主代码库为 `02_DB_Demo_Studio/`。** 新学员或从 Day 1 重走请用 [`day1_guide.md`](day1_guide.md)。  
> 本文件保留 2026-05-27 当日任务（含 `ai_commit_review` 侧车实战）作为历史记录。  
> 文件名：`day1_2026-05-27_guide.md`  
> 日期：2026-05-27  
> 阶段：Phase 1 / W1 / Day 1  
...
| 选项 | 任务 | 为什么适合 Day 1 |
|---|---|---|
| **A（历史推荐）** | 给 `ai_commit_review.py` 接入 LLM API | 2026-05-27 已完成；现为 Kit **可选**工具 |
| **A′（2026-06 主线）** | DB Demo Studio PoC #1 需求澄清 | 见 [`day1_guide.md`](day1_guide.md) 时间块 3 |
...
| Day 5 | 可选 `ai_commit_review.py` 审查 `02_DB_Demo_Studio/` 变更 |
...
> 「按 day1_2026-05-27_guide.md 选项 A，帮我给 ai_commit_review.py 接入 LLM API」
