...
> 总目标：**3 个月**（→ 2026-08-27）见 [`3month_plan.md`](3month_plan.md)  
...
| 优先级 | 任务 | 状态 | 产出 |
|:---:|---|---|---|
| P0 | 初始化 Git 并完成首次 commit | Pending | `git init` + 首次 push |
| P0 | 创建学习管理目录与模板 | Done | `00_*` 目录结构 |
| P0 | 写第一篇 Daily Log | Done | `2026-05-27.md` |
| P1 | 整理 5 个 AI 编程场景 | In Progress | `01_AI_Dev_Workflow_Kit/docs/scenarios.md` |
| P1 | 写第一版 AI 开发工作流 | In Progress | `01_AI_Dev_Workflow_Kit/docs/workflow.md` |
| P2 | 完成 3 个 Prompt 模板 | Pending | `prompts/*.md` |

---

## 每日安排

### Day 1（2026-05-27）— 系统搭建

- [x] 创建 `00_Roadmap`、`00_Learning_Logs`、`00_Notes`、`00_Portfolio`
- [x] 创建 `project_matrix.md`、本周计划、今日日志
- [ ] 阅读路线图 Phase 1 部分，写下 3 条个人学习目标
- [ ] 列出 5 个你日常开发中最想用 AI 加速的场景
...
- [ ] 实现 `scripts/ai_commit_review.py` 基础版
- [ ] 测试：读取 git diff → 生成审查报告
